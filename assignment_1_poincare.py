...
for epsilon in epsilons:
    ...
    omega_minus = fixed_point - epsilon
    omega_plus = fixed_point + epsilon

    P_minus = model.next_impact_velocity(
            fixed_point + eps,
            params,
            timestep,
            impact_timestep,
    ...
    P_plus = model.next_impact_velocity(
            fixed_point - eps,
            params,
            timestep,
            impact_timestep,
    ...
    floquet = (P_plus - P_minus) / (2 * epsilon)
